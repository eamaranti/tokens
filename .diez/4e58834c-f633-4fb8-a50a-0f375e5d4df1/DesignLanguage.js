...
const BXvdlTokens_figma_1 = require("./designs/BXvdlTokens.figma");
/**
 ...
 */
const palette = {
    contentBackground: BXvdlTokens_figma_1.bXvdlTokensTokens.colors.naranjoSuperapp,
    text: BXvdlTokens_figma_1.bXvdlTokensTokens.colors.lightSea,
    caption: BXvdlTokens_figma_1.bXvdlTokensTokens.colors.naranjoMiles,
    headerBackground: prefabs_1.LinearGradient.make(180 /* Bottom */, BXvdlTokens_figma_1.bXvdlTokensTokens.colors.lightSea, BXvdlTokens_figma_1.bXvdlTokensTokens.colors.naranjoMiles),
};
/**
...
const shadows = {
    logo: new prefabs_1.DropShadow({
        ...
        radius: 16,
        color: BXvdlTokens_figma_1.bXvdlTokensTokens.colors.lightOur.fade(0.59),
    }),
};
/**
 ...
 *     `diez-design-tokens-web`. Look for `App.jsx` inside `examples/web` to see
 ...
 *     called `DiezDesignTokens`. Look for `ViewController.swift` inside
