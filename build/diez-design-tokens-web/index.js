...
class Palette {
  constructor({
    contentBackground = {h: 0.5712468193384224, s: 0.5822222222222222, l: 0.5588235294117647, a: 1},
    text = {h: 0.7476190476190476, s: 0.21212121212121215, l: 0.32352941176470584, a: 1},
    caption = {h: 0.9905437352245863, s: 0.6103896103896103, l: 0.45294117647058824, a: 1},
    headerBackground = {stops: [{position: 0, color: {h: 0.06798245614035088, s: 0.9661016949152541, l: 0.4627450980392157, a: 1}}, {position: 1, color: {h: 0.1095679012345679, s: 0.9908256880733946, l: 0.5725490196078431, a: 1}}], start: {x: 0.5, y: 0}, end: {x: 0.5, y: 1}}
  } = {}) {
    /**
     * `PocColoresColors.primary` ( hsla(0.57, 0.58, 0.56, 1) )
     */
    this.contentBackground = new Color(contentBackground);
    /**
     * `PocColoresColors.dark` ( hsla(0.75, 0.21, 0.32, 1) )
     */
    this.text = new Color(text);
    /**
     * `PocColoresColors.danger` ( hsla(0.99, 0.61, 0.45, 1) )
     */
    this.caption = new Color(caption);
    /**
     * start [0.5, 0], end [0.5, 1], stops: [hsla(0.07, 0.97, 0.46, 1) at 0,hsla(0.11, 0.99, 0.57, 1) at 1]
     */
...
class Typography {
  constructor({
    heading1 = {font: {file: {src: "assets/SourceSansPro-Regular.ttf", type: "font"}, name: "SourceSansPro-Regular", fallbacks: ["sans-serif"], weight: 400, style: "normal"}, fontSize: 24, color: {h: 0.7476190476190476, s: 0.21212121212121215, l: 0.32352941176470584, a: 1}, lineHeight: -1, letterSpacing: 0, alignment: "natural", decoration: []},
    body = {font: {file: {src: "assets/SourceSansPro-Regular.ttf", type: "font"}, name: "SourceSansPro-Regular", fallbacks: ["sans-serif"], weight: 400, style: "normal"}, fontSize: 18, color: {h: 0.7476190476190476, s: 0.21212121212121215, l: 0.32352941176470584, a: 1}, lineHeight: -1, letterSpacing: 0, alignment: "center", decoration: []},
    caption = {font: {file: {src: "assets/SourceSansPro-Regular.ttf", type: "font"}, name: "SourceSansPro-Regular", fallbacks: ["sans-serif"], weight: 400, style: "normal"}, fontSize: 14, color: {h: 0.9905437352245863, s: 0.6103896103896103, l: 0.45294117647058824, a: 1}, lineHeight: -1, letterSpacing: 0, alignment: "natural", decoration: []}
  } = {}) {
    /**
     * - font: `SourceSansPro-Regular, 400, normal`
     * - fontSize: `24`
     * - color: `hsla(0.75, 0.21, 0.32, 1)`
     * - iosTextStyle: `body`
     * - shouldScale: `false`
     * - lineHeight: `-1`
     * - letterSpacing: `0`
...
class Shadows {
  constructor({
    logo = {offset: {x: 0, y: 1}, radius: 16, color: {h: 0, s: 0, l: 0.7411764705882353, a: 0.41000000000000003}}
  } = {}) {
    /**
     * - offset: `[0, 1]`
     * - radius: `16`
     * - color: `hsla(0, 0, 0.74, 0.41)`
     */
