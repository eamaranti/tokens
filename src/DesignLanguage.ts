...
import {pocColoresTokens} from './designs/pocColores.figma';
 ...
 */
const palette = {
  contentBackground: pocColoresTokens.colors.primary,
  text: pocColoresTokens.colors.dark,
  caption: pocColoresTokens.colors.danger,
  headerBackground: LinearGradient.make(Toward.Bottom, pocColoresTokens.colors.secondary, pocColoresTokens.colors.warning),
}
...
const shadows = {
  logo: new DropShadow({
    ...
    radius: 16,
    color: pocColoresTokens.colors.gray.fade(0.59),
  }),
}
