...
const pocColores_figma_1 = require("./designs/pocColores.figma");
/**
 ...
 */
const palette = {
    contentBackground: pocColores_figma_1.pocColoresTokens.colors.primary,
    text: pocColores_figma_1.pocColoresTokens.colors.dark,
    caption: pocColores_figma_1.pocColoresTokens.colors.danger,
    headerBackground: prefabs_1.LinearGradient.make(180 /* Bottom */, pocColores_figma_1.pocColoresTokens.colors.secondary, pocColores_figma_1.pocColoresTokens.colors.warning),
};
/**
...
const shadows = {
    logo: new prefabs_1.DropShadow({
        ...
        radius: 16,
        color: pocColores_figma_1.pocColoresTokens.colors.gray.fade(0.59),
    }),
};
/**
