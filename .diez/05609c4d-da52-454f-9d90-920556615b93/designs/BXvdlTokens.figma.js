...
const bXvdlTokensColors = {
    ...
    naranjoSuperapp: prefabs_1.Color.rgba(255, 126, 68, 1),
...
exports.bXvdlTokensImagesFiles = {
    blueSuperapp: new prefabs_1.File({ src: "assets/BXvdlTokens.figma.contents/images/BlueSuperapp.png" }),
    blueSuperapp2x: new prefabs_1.File({ src: "assets/BXvdlTokens.figma.contents/images/BlueSuperapp@2x.png" }),
    blueSuperapp3x: new prefabs_1.File({ src: "assets/BXvdlTokens.figma.contents/images/BlueSuperapp@3x.png" }),
    blueSuperapp4x: new prefabs_1.File({ src: "assets/BXvdlTokens.figma.contents/images/BlueSuperapp@4x.png" }),
    palette: new prefabs_1.File({ src: "assets/BXvdlTokens.figma.contents/images/Palette.png" }),
    palette2x: new prefabs_1.File({ src: "assets/BXvdlTokens.figma.contents/images/Palette@2x.png" }),
    palette3x: new prefabs_1.File({ src: "assets/BXvdlTokens.figma.contents/images/Palette@3x.png" }),
    palette4x: new prefabs_1.File({ src: "assets/BXvdlTokens.figma.contents/images/Palette@4x.png" })
};
/**
...
exports.bXvdlTokensImages = {
    blueSuperapp: prefabs_1.Image.responsive("assets/BXvdlTokens.figma.contents/images/BlueSuperapp.png", 181, 100),
    palette: prefabs_1.Image.responsive("assets/BXvdlTokens.figma.contents/images/Palette.png", 2124, 1131)
};
/**
