...
exports.bXvdlStyleDictionaryDesignTokensTokens = exports.bXvdlStyleDictionaryDesignTokensFonts = void 0;
/**
 * This code was generated by Diez version 10.6.0.
 * Changes to this file may cause incorrect behavior and will be lost if the code is regenerated.
 */
const prefabs_1 = require("@diez/prefabs");
const bXvdlStyleDictionaryDesignTokensColors = {
...
exports.bXvdlStyleDictionaryDesignTokensFonts = {
    RobotoLight: {
        Regular: prefabs_1.Font.fromFile("assets/BXvdlStyleDictionaryDesignTokens.figma.contents/fonts/Roboto-Light.ttf")
    },
    Roboto: {
        Regular: prefabs_1.Font.fromFile("assets/BXvdlStyleDictionaryDesignTokens.figma.contents/fonts/Roboto-Regular.ttf")
    }
};
const bXvdlStyleDictionaryDesignTokensTypography = {
    caption: new prefabs_1.Typograph({ letterSpacing: 0, fontSize: 10, lineHeight: 11.71875, color: prefabs_1.Color.rgba(15, 51, 101, 1), font: exports.bXvdlStyleDictionaryDesignTokensFonts.RobotoLight.Regular }),
    grisUp: new prefabs_1.Typograph({ letterSpacing: 0.42, fontSize: 14, lineHeight: 17.220001220703125, color: prefabs_1.Color.rgba(51, 51, 51, 1), font: exports.bXvdlStyleDictionaryDesignTokensFonts.Roboto.Regular }),
    ...
    paragraph1: new prefabs_1.Typograph({ letterSpacing: 0.42, fontSize: 14, lineHeight: 22.1200008392334, color: prefabs_1.Color.rgba(246, 246, 246, 1), font: exports.bXvdlStyleDictionaryDesignTokensFonts.Roboto.Regular })
};
exports.bXvdlStyleDictionaryDesignTokensTokens = {
    colors: bXvdlStyleDictionaryDesignTokensColors,
    typography: bXvdlStyleDictionaryDesignTokensTypography
};
//# sourceMappingURL=BXvdlStyleDictionaryDesignTokens.figma.js.map